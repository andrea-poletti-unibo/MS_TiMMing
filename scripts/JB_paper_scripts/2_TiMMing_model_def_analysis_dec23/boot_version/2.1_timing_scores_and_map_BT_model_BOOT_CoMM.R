...
files <- list.files("workfiles/CoMMpass_boots", full.names = T, pattern = "matches")
...
dir.create("results/JB_paper/def_aug23/CoMMpass_20boots/", showWarnings = F, recursive = T)
write_tsv(res_all, "results/JB_paper/def_aug23/CoMMpass_20boots/CoMMpass_timings_20boot.txt")

res_all <- fread("results/JB_paper/def_aug23/CoMMpass_20boots/CoMMpass_timings_20boot.txt")
...
write_tsv(res_all, "workfiles/CoMMpass_boots/BTmodels_20BOOTS_CoMMpass.txt")
write_tsv(res_all_boots, "workfiles/CoMMpass_boots/Aggregate_BTmodels_20BOOTS_CoMMpass.txt")
...
p1 <- res_all %>% ggplot(aes(x=timing, y = cna_f)) + 
  ...
  ylab("CNA") +
  ggtitle("Bradley-Terry CNAs timing estimates on CoMMpass cohort", subtitle = "20 bootstraps runs")
...
# save plot
ggsave(plot = p1, filename =  "plots/timing_maps/boot_approach/CoMMpass_timing_map_20BOOTS.png", width = 14, height = 12, units = "in")
...
p2 <- res_all_hi %>% ggplot(aes(x=timing, y = cna_f)) + 
  ...
  xlab("Timing Estimate") +
  ylab("CNA") +
  ggtitle("Bradley-Terry CNAs timing estimates on CoMMpass new cohort", subtitle = "20 bootstraps runs") + xlim(0,6.6)

p2

# save plot
ggsave(plot = p2, filename =  "plots/timing_maps/boot_approach/CoMMpass_timing_map_20BOOTS_hifreq.png", width = 14, height = 12, units = "in")