...
files <- list.files("workfiles/SU2Cnew&BUSnew_boots", full.names = T, pattern = "matches")
...
write_tsv(res_all, "workfiles/SU2Cnew&BUSnew_boots/BTmodels_20BOOTS_SU2Cnew&BUSnew.txt")
write_tsv(res_all_boots, "workfiles/SU2Cnew&BUSnew_boots/Aggregate_BTmodels_20BOOTS_SU2Cnew&BUSnew.txt")
...
# save plot
ggsave(plot = p1, filename =  "plots/timing_maps/boot_approach/SU2Cnew&BUSnew_timing_map_20BOOTS.png", width = 14, height = 12, units = "in")
