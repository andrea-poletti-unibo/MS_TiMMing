...
write_tsv(calls_0, "workfiles/AllTogether_model/prep_calls_SMM.txt")
write_tsv(CI95_0, "workfiles/AllTogether_model/prep_CI95_SMM.txt")
write_tsv(purity_0, "workfiles/AllTogether_model/prep_purity_SMM.txt")


# FINAL COHORT SMM n= 325 samples
export_samples_list <- data.frame(sample = calls$sample)

# write_tsv(export_samples_list, "workfiles/SMM_def_cohort_samples_SU2Cnew_BUSnew.txt")
...
for (b in 1:20) {
    ...
    dir.create("workfiles/SU2Cnew&BUSnew_boots/", showWarnings = FALSE, recursive = TRUE)

    # save aggregated table with points
    write_tsv(expscorestab, paste0("workfiles/SU2Cnew&BUSnew_boots/SU2Cnew&BUSnew_BOOT_",b,"_matches_results_ClonDiffPoints.txt"))
}

stopCluster(cl)

write_tsv(boot_data, "workfiles/SU2Cnew&BUSnew_boots/SU2Cnew&BUSnew_BOOT-data.txt")