...
com <- fread("results/JB_paper/def_aug23/validation_tests/T2_split_SMM/splitSMM-a_timings_20boot.txt")
...
smm <- fread("results/JB_paper/def_aug23/validation_tests/T2_split_SMM/splitSMM-b_timings_20boot.txt")
...
# SET AT 20% frequency cutoff - defined by the "saturation" analysis curve
hifreq <- cs_w$variable[cs_w$frequency>0.20] %>% as.character()
hifreq
...
# save plot
ggsave("results/JB_paper/def_aug23/validation_tests/T2_split_SMM/compare_Viz1_timings_BOOTS.png", width = 7, height = 6, dpi = 300)
...
# save plot
ggsave("results/JB_paper/def_aug23/validation_tests/T2_split_SMM/compare_Viz2_timings_BOOTS.png", width = 7, height = 6, dpi = 300)
